...
PM_START_TEXT = """
**Hello {}, My Name is {}!** 
I am an **SparrowBot**  group management bot.
...
TECHNO_IMG = "https://telegra.ph/file/5be505eb97aab604353f5.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/hactivisam")],
                                                                                   [InlineKeyboardButton(text="ADD SparrowBot TO YOUR GROUP⚡",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Any Help",
                                                                       url="t.me/hactivisam")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("SparrowBot IS ALWAYS ACTIVE!!")
